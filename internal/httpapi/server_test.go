...
func TestHealth(t *testing.T) {
	...
	NewHandler(authenticationServiceStub{}, teamServiceStub{}, tokenParserStub{}).ServeHTTP(response, request)
...
func TestRegister(t *testing.T) {
	...
	}, teamServiceStub{}, tokenParserStub{}).ServeHTTP(response, request)
...
func TestLoginRejectsInvalidCredentials(t *testing.T) {
	...
	NewHandler(authenticationServiceStub{loginError: user.ErrInvalidCredentials}, teamServiceStub{}, tokenParserStub{}).ServeHTTP(response, request)
