...
func TestHealth(t *testing.T) {
	...
	NewHandler(authenticationServiceStub{}).ServeHTTP(response, request)
...
func TestLoginRejectsInvalidCredentials(t *testing.T) {
	...
	NewHandler(authenticationServiceStub{loginError: user.ErrInvalidCredentials}).ServeHTTP(response, request)
